...
const quickReplies = [
  'מה המטריקות האלה?',
  'איך נבחר מסלול?',
  'מה התהליך אחרי החתימה?',
  'רוצה לראות ROI אמיתי',
];

const botResponses: Record<string, string> = {
  'מה המטריקות האלה?': 'הגרף ב-Hero משקף 2.4M הכנסות, 85% המרה ו-12K עלויות. כל המסלולים מתוכננים כדי לשמר את הנתון הזה ולשפר אותו.',
  'איך נבחר מסלול?': 'תסתכל על מסלולי ה-Tracks: חברות מבוססות, שותפות אחוז, ו-יזמים מתחילים. כל אחד מגיע עם פרטים ברורים, badges והסבר למתי לבחור אותו.',
  'מה התהליך אחרי החתימה?': 'ה-Process כולל 5 שלבים גלויים ב-ProcessSection – פגישה, אסטרטגיה, פיתוח, השקה וצמיחה מתמשכת. תמיד תדע מה קורה בשלב הבא.',
  'רוצה לראות ROI אמיתי': 'יש לנו ROI Calculator שיושב אחרי מסלולי העבודה ונותן תחושת הביצה. רוצה שאתן קישור ישיר אליו?',
...
export default function AIChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: 'שלום! אני כאן כדי לספר על +340% ROI, 85% המרה והפתרונות שלנו בשבילך. במה תרצה שנעזור?',
      sender: 'bot',
      timestamp: new Date(),
    },
  ]);
